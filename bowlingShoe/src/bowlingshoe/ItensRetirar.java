 ...
 * @author hmarinho
 */
public class ItensRetirar extends javax.swing.JDialog {

    /**
     * Creates new form ItensRetirar
     */
    public ItensRetirar(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(546, 323));
        setResizable(false);
    ...
    private void btCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCancelarActionPerformed
        ...
        if (n == 0){
            ItensRetirar.this.setVisible(false);
        }
